      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        {isSubPage ? (
          <div className="flex items-center">
            <Link 
              href="/" 
              className="group flex items-center gap-2 px-4 py-2 rounded-full bg-[#151b2d]/60 border border-[#3a4a43]/30 text-sm text-[#dce1fb]/70 hover:text-[#00FFC2] hover:border-[#00FFC2]/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,255,194,0.15)] focus-visible:outline-2 focus-visible:outline-[#00FFC2] focus-visible:outline-offset-2"
            >
              <span className="relative flex items-center justify-center w-6 h-6 rounded-full bg-[#00FFC2]/10 group-hover:bg-[#00FFC2]/20 transition-colors">
                <ArrowLeft className="w-3.5 h-3.5 text-[#00FFC2] group-hover:-translate-x-0.5 transition-transform duration-300" />
              </span>
              <span className="hidden sm:inline font-medium">Volver</span>
            </Link>
          </div>
        ) : (
          <div className="w-24 md:w-28" /> /* Spacer */
        )}
